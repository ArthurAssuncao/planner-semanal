      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead className="bg-gray-100">
            <tr>
              <th className="px-3 py-3 text-left font-semibold text-gray-700 w-16">Turno</th>
              <th className="px-3 py-3 text-left font-semibold text-gray-700 w-20">Horário</th>
                  ...
                  >
                    {activity ? (
                      activity.isFirst ? (
                        <div
                          draggable
                          onDragStart={(e) => handleDragStart(e, activity, true, scheduleKey)}
                        ...
                        >
                          <span className="screen:truncate text-xs">{activity.name}</span>
                          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                            <div className="flex flex-col">
                              <button
                                onClick={(e) => {
                                  e.stopPropagation();
                                  adjustActivityDuration(currentDay, slot.time, true);
                                }}
                              ...
                              <button
                                onClick={(e) => {
                                  e.stopPropagation();
                                  adjustActivityDuration(currentDay, slot.time, false);
                                }}
                            ...
                            <span className="text-xs mx-1">{activity.duration * 15}min</span>
                            <button
                              onClick={(e) => {
                                e.stopPropagation();
